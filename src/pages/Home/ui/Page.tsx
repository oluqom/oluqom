    ...
    <>
      <section className="bg-base-200">
        <div className="hero relative min-h-[calc(100vh-128px)] container">
          <div className="hero-content flex-col gap-x-8 lg:flex-row-reverse">
            <img
              src="/me.jpg"
              className="sm:max-w-sm max-w-xs z-40 mask mask-squircle shadow-2xl shadow-primary"
            />
            <div className="flex flex-col gap-y-5">
              <h1 className="text-3xl sm:text-5xl text-center sm:text-left font-bold text-white">
                Hi, I'm Aleksey
              </h1>
              <p className="text-lg sm:text-2xl font-normal text-white text-center sm:text-left">
          ...
          <div className="gap-x-5 py-20 justify-center flex items-center">
            <div className="flex flex-col gap-y-3 w-[600px]">
              <h2 className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-primary">
                YumeTune
              </h2>maxavorite Japanese anime and video
      ...
      <section className="bg-base-200">
        <div className="container py-32 flex flex-col gap-y-3">
          <h2 className="text-xl sm:text-4xl text-white font-bold">About Me</h2>
